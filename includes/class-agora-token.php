...
require_once MEDITAJ_PATH . 'includes/agora/Util.php';
require_once MEDITAJ_PATH . 'includes/agora/AccessToken2.php';
require_once MEDITAJ_PATH . 'includes/agora/RtcTokenBuilder2.php';
...
class AgoraToken {
	...
	public static function generate_token( $channel_name, $uid, $role = 1, $expire_sec = 3600 ) {
		...
		$app_certificate = get_option( 'meditaj_agora_app_certificate', '' );
