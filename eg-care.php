...
// Schema changes are handled by DB::create_tables(), which the version check
// further down runs only when DB_VERSION moves. There used to be a second
// migration here that fired SHOW TABLES + SHOW COLUMNS on every request.
